...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                onQuitClick(); // Call this when 'x' is clicked INSTEAD of closing
            }
        });
    ...
    protected void onSaveClick() {
        ...
        isDirty = false;  // For now, saving always succeeds
    }
    ...
    protected boolean okToExit() {  // Returns true if OK to exit
        if (!isDirty) return true;  // OK to exit if data already saved
        ...
        if (choice == JOptionPane.YES_OPTION) {
            onSaveClick();
            return !isDirty; // OK to exit only is saved successfully
        } 
