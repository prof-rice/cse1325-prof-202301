...
*/        
        ...
        // Pen > Thread
        JMenuItem numThreads  = new JMenuItem("Threads");
        numThreads.addActionListener((ActionEvent event) -> onThreadsClick());
        pen.add(numThreads);
/*        
...
*/
        ...
        // Create the Threads button
        JButton threadsButton  = 
            new JButton(new ImageIcon("resources/threads.png"));
        threadsButton.setActionCommand("SelectNumberOfThreads");
        threadsButton.setToolTipText("Select the number of threads");
        toolbar.add(threadsButton);
        threadsButton.addActionListener((ActionEvent event) -> onThreadsClick());
/*        
...
*/
    ...
    public void componentResized(ComponentEvent ce) {
        ...
        //System.out.println("JFrame resized to " + size + ", resizing canvas");
        canvas.resize(new Dimension(size, size));
        revalidate();
        canvas.clear();
        new Mandelbrot(canvas, threads);
...
//        canvas.redo(); 
    ...
    protected void onThreadsClick() {   // Select number of threads
        JLabel label = new JLabel("Threads");
        SpinnerModel range = new SpinnerNumberModel(threads, 1, 1024, 1);
        JSpinner spinner = new JSpinner(range);
        ...
        if(button == JOptionPane.OK_OPTION) { // If OK clicked, update threads
            threads = (Integer) spinner.getValue();
            canvas.clear();
            new Mandelbrot(canvas, threads);
        }
    }
...
//        {"Solid Line", "Dashed Line", "Dotted Line", "Dash-Dot Line"};
   ...
   protected void onAboutClick() {                 // Display About dialog
        ...
        JLabel title = new JLabel("<html>"
          + "<p><font size=+4>CSE1325 Mandelbrot</font></p>"
          + "</html>");
        about.add(title);

        JLabel artists = new JLabel("<html>"
          + "<p>Version " + VERSION + "</p>"
          + "<p>Copyright 2017-2022 by George F. Rice</p>"
          + "<p>Licensed under Gnu GPL 3.0</p>"
          + "<br/>"
          + "<p>Logo by XeiexianZero Zero at Public Domain Pictures.net</p>"
          + "<p>Some icons from Freepik per the Freepik Terms of Use (June 2019)</p>"
          + "<p>-- Save As icon by Kiranshastry</p>"
          + "<p>-- Brush icon by Good Ware</p>"
          + "<p>-- Thread icon by Rank Sol from NounProject.com</p>"
          + "<p>-- Undo and Redo icons by Pixel Perfect</p>"
